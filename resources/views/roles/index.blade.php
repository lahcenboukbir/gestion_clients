                        ...
                        <tbody>
                            @foreach ($roles as $role)
                                <tr class="align-baseline">
                                    ...
                                    <td>{{$role->name}}</td>
                                    <td>
                                        <a href="{{route('roles.show', $role->id)}}" class="btn btn-success btn-sm py-0 px-2">
                                            <span class="mdi mdi-eye-outline"></span>
                                        </a>

                                        <a href="{{route('roles.edit', $role->id)}}" class="btn btn-warning btn-sm py-0 px-2">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="deleteModal{{$role->id}}">
