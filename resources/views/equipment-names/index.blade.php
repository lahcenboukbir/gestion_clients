        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Liste des noms d'équipements</h5>
                </div>
                ...
                <div class="card-body">
                            ...
                            @foreach ($equipments as $equipment)
                                <tr class="align-baseline">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('equipment.names.edit', $equipment->id) }}"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="deleteModal{{ $equipment->id }}">
                                                            Supprimer {{ $equipment->equipment_name }}</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('equipment.names.destroy', $equipment->id) }}"
                    ...
                    <div class="mt-3">
                        <a href="{{ route('equipment.names.create') }}" class="btn btn-success">Ajouter</a>
                    </div>
